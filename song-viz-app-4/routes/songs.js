    ...
    try {
        ...
        const result = await pool.query(`
            SELECT 
                ...
                s.title,
                s.artist,
                u1.username as recommender_name,
            ...
            JOIN users u1 ON r.recommender_id = u1.user_id
            JOIN users u2 ON r.recipient_id = u2.user_id
            ORDER BY r.recommendation_date DESC
            LIMIT 20
        `);

        console.log('Found recommendations:', result.rows);
